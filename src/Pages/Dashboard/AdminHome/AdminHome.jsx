...
import { FaList, FaMoneyBill, FaUserAlt } from 'react-icons/fa';
...
const AdminHome = () => {
    ...
    const { data: charts = [] } = useQuery({
        ...
        queryFn: async () => {
            const res = await axiosSecurepublic.get('/order-stats')
            return res.data;
        }
    })
    ...
    const pieChartsData=charts.map(data=>{
    ...
    return (
        <div className='p-5'>
            <h2 className='text-3xl'>Hi wellcome {user?.displayName}</h2>

            <div className="stats shadow max-w-full py-10 flex justify-center">
                <div className="stat">
                    <div className="stat-figure text-secondary">
                        <FaMoneyBill className='text-2xl'></FaMoneyBill>
                    </div>
